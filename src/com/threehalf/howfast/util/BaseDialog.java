...
public class BaseDialog extends Dialog implements
	...
	private Context mContext;// 上下�?
	private LinearLayout mLayoutRoot;// 总体根布�?
	private LinearLayout mLayoutTop;// 头部根布�?
	private LinearLayout mLayoutTitle;// 标题根布�?
	private TextView mHtvTitle;// 标题
	private View mViewTitleLine;// 标题分割�?
	private LinearLayout mLayoutContent;// 内容根布�?
	private TextView mHtvMessage;// 内容
	private LinearLayout mLayoutBottom;// 底部根布�?
	...
	private OnClickListener mOnClickListener1;// 按钮1的单击监听事�?
	private OnClickListener mOnClickListener2;// 按钮2的单击监听事�?
	private OnClickListener mOnClickListener3;// 按钮3的单击监听事�?
